            ...
            <main class="main-content">
                <div class="Tmain-content">
                    ...
                    <div class="heading-row">
                        ...
                        <form id="createAppointmentForm" action="/lab_sync/index.php?controller=appointmentsController&action=storeAppointment" method="POST" class="appointment-form formStyle"><br>
                            <?php if ($prefillRequestId > 0): ?>
                            ...
                            <input type="hidden" id="patient_id" name="patient_id" required value="<?php echo $prefillPatientId > 0 ? (int)$prefillPatientId : ''; ?>">
