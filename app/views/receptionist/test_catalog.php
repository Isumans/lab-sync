...
<div class="Tmain-content" data-role="<?php echo htmlspecialchars($role); ?>">
    <div class="test-catalog-header">
        <h1>Test Catalog</h1>
        <a href="/lab_sync/index.php?controller=TestCatalog&action=add_test&role=<?php echo urlencode($role); ?>" id="openAddTest" class="add-test-button btn btn-primary">+ Add New Test</a>
    </div>
    ...
    <div class="select-category">
        <select class="category-filter" name="category-filter">
