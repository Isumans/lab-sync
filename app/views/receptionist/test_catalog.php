...
<div class="Tmain-content">
    <div class="test-catalog-header">
        <h1>Test Catalog</h1>
        <a href="/lab_sync/index.php?controller=TestCatalog&action=add_test&role=<?php echo urlencode($role); ?>"
            id="openAddTest" class="add-test-button">+ Add New Test</a>
    </div>
    ...
    <div class="search-and-filter">
        ...
        <div class="filter-wrapper">
            ...
            <select class="category-filter" id="category-filter" name="category-filter">
        ...
        <tbody>
            <?php if (is_array($packages) && count($packages) > 0): ?>
                <?php foreach ($packages as $package): ?>
                    <tr class="test-row" data-id="<?php echo htmlspecialchars($package['test_id']); ?>"
                        ...
                        <td>
                            <div class="action-buttons">
                                <button type="button" class="edit-btn" title="Edit"><img src="/lab_sync/public/assests/edit.png"
                                        alt="Edit"></button>
                                <button type="button" class="delete-btn" title="Delete"><img
                                        src="/lab_sync/public/assests/delete.png" alt="Delete"></button>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td colspan="5">No tests found or database error.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
<div id="editTestModal" class="modal-overlay">
    <div class="modal-content">
        ...
        <form id="editTestForm" method="post"
            action="/lab_sync/index.php?controller=TestCatalog&action=edit_test&role=<?php echo urlencode($role); ?>">
            <input type="hidden" name="test_id" value="" />

            <div class="modal-body">
                <div class="form-row">
                    <label for="test_name">Test Name</label>
                    <input type="text" id="test_name" name="test_name" placeholder="Comprehensive Metabolic Panel"
                        required />
                </div>
