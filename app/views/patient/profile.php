<?php /* app/views/patient/profile.php */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
      ...
      <form class="profile-form" onsubmit="return false">
        <div class="pf-grid">
          <div class="pf-field">
            ...
            <input id="pfName" class="input input-lg" type="text" placeholder="John Doe" value="John Doe"/>
          </div>

          <div class="pf-field">
            <label class="label">Email</label>
            <input id="pfEmail" class="input input-lg" type="email" placeholder="john@example.com"/>
          </div>

          <div class="pf-field">
            <label class="label">Contact Number</label>
            <input id="pfPhone" class="input input-lg" type="tel" placeholder="+94 77 123 4567"/>
          </div>

          <div class="pf-field">
            <label class="label">WhatsApp Number</label>
            <input id="pfWhats" class="input input-lg" type="tel" placeholder="+94 77 123 4567"/>
          </div>

          <div class="pf-field pf-wide">
            <label class="label">Address</label>
            <textarea id="pfAddr" class="input input-lg" rows="3" placeholder="123 Main Street, Colombo"></textarea>
          </div>
        </div>

        <div class="profile-actions">
          <button class="btn-outline" type="button" onclick="profileReset()">Cancel</button>
          <button class="btn-primary" type="submit" onclick="profileSave()">Save Changes</button>
        </div>
      </form>
    </section>
