...
<main class="container">
  ...
  <div class="catalog">
    ...
    <div class="card test-card" id="<?= $id ?>">
      ...
      <button class="btn-primary" onclick="location.href='<?= asset('app/views/patient/book.php?test='.urlencode($name)) ?>'">Book Test</button>
...
function openTestModal(name, prep, dur){
  ...
  btn.onclick = () => location.href = '<?= asset('app/views/patient/book.php?test=') ?>' + encodeURIComponent(name);
