...
<main class="container">
  ...
  <div class="dash-grid">
    ...
    <aside class="card">
      <h3>Quick Actions</h3>
      <div class="list">
        <a class="btn-primary" href="<?= asset('app/views/patient/explore.php') ?>">Book Test</a>
        <a class="btn-outline" href="<?= asset('app/views/patient/results.php') ?>">View Results</a>
      </div>
    </aside>
  </div>
  ...
  <div class="card" style="margin-top:16px">
    ...
    <div class="row" style="margin-bottom:10px">
      <a class="btn-primary" href="<?= asset('app/views/patient/explore.php') ?>">+ New Appointment</a>
    </div>
    <div id="list" class="list"></div>
    <div id="empty" class="muted empty">
      No appointments yet — <a href="<?= asset('app/views/patient/explore.php') ?>">Book your first test</a>.
    </div>
  </div>
</main>
